...
export function AppHeader({ user }: AppHeaderProps) {
  ...
  return (
    <>
      <header className="h-16 border-b border-border/80 bg-background/80 backdrop-blur-md px-4 sm:px-6 lg:px-8 flex items-center justify-between sticky top-0 z-30">
        {/* Mobile menu button */}
